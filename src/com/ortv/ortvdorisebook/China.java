...
public class China extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		videoBtn = (Button) findViewById(R.id.china_video_btn);
		pdfBtn = (Button) findViewById(R.id.china_pdf_btn);
	...
	public void onClick(View v) {
		Intent intent = null;
		switch (v.getId()) {
		case R.id.china_video_btn:
			break;
		case R.id.china_pdf_btn:
			intent = new Intent(this, ViewPagerActivity.class);
			intent.putExtra("PageNo", 65);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.china_menu, menu);
		return true;
	}
