...
public class Taipei extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		videoBtn = (Button) findViewById(R.id.taipei_video_btn);
		pdfBtn = (Button) findViewById(R.id.taipei_pdf_btn);
	...
	public void onClick(View v) {
		Intent intent = null;
		switch (v.getId()) {
		case R.id.taipei_video_btn:
			break;
		case R.id.taipei_pdf_btn:
			intent = new Intent(this, ViewPagerActivity.class);
			intent.putExtra("PageNo", 161);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.taipei_menu, menu);
		return true;
	}
